...
public class MergeSort {
    ...
    public static void main(String[] args) {
        int[] arreglo = {38, 27, 43, 3, 9, 82, 10}; // Array desordenado

        System.out.println("Array desordenado: " + Arrays.toString(arreglo));

        // Llama al método mergeSort para ordenar el array
        mergeSort(arreglo);
